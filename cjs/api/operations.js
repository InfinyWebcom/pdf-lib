...
exports.drawLinesOfText = function (lines, options) {
    var translatething = options.matrix ? operators_1.setTextMatrix(options.matrix[0], options.matrix[1], options.matrix[2], options.matrix[3], options.x, options.y) : operators_1.rotateAndSkewTextRadiansAndTranslate(rotations_1.toRadians(options.rotate), rotations_1.toRadians(options.xSkew), rotations_1.toRadians(options.ySkew), options.x, options.y);
    var operators = [
        operators_1.pushGraphicsState(),
        options.graphicsState && operators_1.setGraphicsState(options.graphicsState),
        operators_1.beginText(),
